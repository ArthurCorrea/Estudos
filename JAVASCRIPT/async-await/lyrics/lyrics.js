...
async function doSubmit() {
    ...
    lyrics_el.innerHTML = '<div class="spinner-border" role="status"><span class="sr-only">Carregando...</span></div>';
    
    console.log(artist.value, song.value);
